    ...
    <div className="mt-16 px-4">
      ...
      <div className="mt-8">
        <div className="flex flex-col items-center">
          <h5 className="text-sm text-grey-500 font-medium">Enter using:</h5>
          ...
          <div className="mt-1">
            ...
            {method === 'phone' ? (
              <div className="flex rounded-md shadow-sm">
                <span className="flex items-center justify-center px-3 rounded-l-md border border-r-0 border-gray-300 bg-bray-50 text-gray-500 selection-none text-sm">
                  +82
                </span>
                <input
                  id="input"
        ...
        <div className="mt-8">
          <div className="relative">
            ...
            <div className="relative -top-4 text-center">
