    ...
    <div className="bg-slate-400 py-20 px-20 grid gap-10 min-h-screen">
      <div className="bg-white p-6 rounded-2xl shadow-xl ">
        ...
        <div className="flex justify-between">
          <span className="text-grey-500">Tooly Table</span>
          <span className="font-semibold">$19</span>
        </div>
      ...
      <div className="bg-white overflow-hidden rounded-2xl shadow-xl">
        ...
        <div className="rounded-2xl p-6 bg-white relative -top-7">
          <div className="flex relative -top-16 items-end justify-between">
            <div className="flex flex-col items-center mx-10">
              <span className="text-xs text-grey-500">Orders</span>
          ...
          <div className="relative flex flex-col items-center -mt-14 -mb-5">
            ...
            <span className="text-sm text-grey-500">미국</span>
          </div>
        </div>
      </div>
      <div className="bg-white p-6 rounded-2xl shadow-xl">
        ...
        <div className="flex flex-col">
          ...
          <span className="text-xs text-grey-500">Chair</span>
          <div className="mt-3 mb-5 flex justify-between items-center">
            ...
            <div className="flex items-center space-x-5">
              <button className="rounded-lg bg-blue-200 flex justify-center items-center aspect-square w-8 text-xl text-grey-500">
                -
              </button>
              <span>1</span>
              <button className="rounded-lg bg-blue-200 flex justify-center items-center aspect-square w-8 text-xl text-grey-500">
